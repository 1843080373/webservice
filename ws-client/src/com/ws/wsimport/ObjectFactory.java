 ...
 * generated in the com.ws.wsimport package. 
...
public class ObjectFactory {
    ...
    private final static QName _QueryWeatherResponse_QNAME = new QName("http://service.wx.com/", "queryWeatherResponse");
    private final static QName _QueryWeather_QNAME = new QName("http://service.wx.com/", "queryWeather");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: com.ws.wsimport
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.wx.com/", name = "queryWeatherResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://service.wx.com/", name = "queryWeather")
